...
public class Results2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                Intent intent = new Intent(Results2.this, Results3.class);
                startActivity(intent);
                Results2.this.finish();
            }
        });
    ...
    protected void onResume() {
        ...
        if(Paper.book().read("test2id")!=null){
            ...
            if((Integer) Paper.book().read("test2id")!=r1.getId()){
                RadioButton rr = findViewById((Integer) Paper.book().read("test2id"));
